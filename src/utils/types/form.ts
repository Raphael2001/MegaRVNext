...
export type OnChangeValue = string | Array<string | GeneralServerItem> | number | File | TimePickerValue | Date | Boolean;
...
export interface MultiSelectAutoCompleteProps extends MultiSelectAutoCompleteDataProps {
	options: Array<GeneralOptionItem>;
	field?: string;
}
