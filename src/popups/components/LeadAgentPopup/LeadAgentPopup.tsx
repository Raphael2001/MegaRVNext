...
import { LeadAgent } from "utils/types/init";
...
export default function LeadAgentPopup(props: Props) {
	...
	function onSubmit(payload, onSuccess) {
		if (dataItem) {
			...
			return Api.cms.leadAgents.PUT({ payload, config: { onSuccess } });
		}
		Api.cms.leadAgents.POST({ payload, config: { onSuccess } });
	}
